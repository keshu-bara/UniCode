    ...
    <footer className="bg-gray-900 text-gray-300 w-full py-3 px-6 border-t border-gray-800 mt-auto">
      <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between">
        <div className="copyright flex items-center mb-2 sm:mb-0">
          ...
          <span className="text-xs sm:text-sm font-light ml-2 opacity-80">© {new Date().getFullYear()} All Rights Reserved</span>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link to="/privacy" className="text-sm hover:text-blue-400 transition-colors duration-300">
            Privacy
          </Link>
          <Link to="/contactdev" className="text-sm bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded-md transition-colors duration-300">
            Contact Developer
          </Link>
        </div>
      </div>
